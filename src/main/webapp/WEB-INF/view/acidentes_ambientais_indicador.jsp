...
<title>Painel Acidentes Ambiental</title>
...
<![endif]-->
<script src="<c:url value="/js/painel_gr.js"/>"></script>
...
<body id="painel-acidentes-ambientais">
    <div id="painel-titulo">Acidentes Ambiental</div>
